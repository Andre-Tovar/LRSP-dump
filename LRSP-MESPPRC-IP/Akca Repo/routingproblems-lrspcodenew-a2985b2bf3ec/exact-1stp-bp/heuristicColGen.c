...
void CWAlgorithm (double **d,double **rc, int *customers, int *Demand, int TIMELIMIT, int VCap, int fac,int NCust, double VFcost, double VOcost, LABEL_NODE **ColumnLabels, double vehicle_dual) {
...
int heur_column_generation_main(double **d, double **rc,int fac,double radius, double v_dual, LABEL_NODE **ColList) {
