...
def calibrate_instance(
    ...
    The `mespprc_vrp` package is intended to plug into an upstream VRP workflow and is
    not calibrated around full-cover feasibility. The function is kept only for package
    parity with `mespprc`.
    """
