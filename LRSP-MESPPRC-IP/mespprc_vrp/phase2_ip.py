...
class Phase2IPPricingSolver:
    """
    IP alternative for the Phase 2 pricing pairing problem.
    ...
    def solve(
        ...
        *,
        ...
        model = LpProblem("mespprc_vrp_phase2_pricing", LpMinimize)
        route_vars = [
        ...
        *,
        ...
        if infeasibility_reason == NO_NEGATIVE_ROUTES_FROM_PHASE1:
            ...
            summary = (
                ...
                "resource limits prevent any nonempty feasible selection."
            )
        else:
            summary = (
                "Phase 2 IP pricing solved a reduced negative-route pool with "
