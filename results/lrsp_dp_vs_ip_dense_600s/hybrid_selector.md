...
Trained on the dense LRSP DP-vs-IP sweep (`results\lrsp_dp_vs_ip_dense_600s\cells.csv`).

## Models tried

| Model | 5-fold CV accuracy | Cells used |
|-------|-------------------:|-----------:|
| Majority-class baseline (always_ip) | 0.958 | 165 |
| Pool-size threshold rule | 0.964 | 165 |
| Logistic regression (9 features) | 0.958 | 165 |
| Logistic regression (all features) | 0.958 | 165 |
